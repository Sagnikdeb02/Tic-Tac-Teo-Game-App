This is a simple Tic Tac Toe offline game using Kotlin. It's an native android app. There are option for single player Vs Computer and player Vs Player (Two player).
